...
abstract class Connection implements LoggerAwareInterface
{
	...
	/**
	 * @var  FuelPHP\Database\Compiler  $compiler  query compiler
	 */
	protected $compiler;

	/**
	 * @var  FuelPHP\Database\Compiler\Schema  $schemaCompiler  query schema compiler
	 */
	protected $schemaCompiler;

	/**
	 * @var  FuelPHP\Database\Schema  $schema  schema
	 */
	protected $schema;
	...
	public function getCompiler()
	{
		if ( ! $this->compiler)
		{
			...
			$class = 'FuelPHP\Database\Compiler\\'.$driver;
